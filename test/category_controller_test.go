...
import (
	...
	"fxlik/golang-restful-api/model/domain"
...
func setupTestDB() *sql.DB {
	db, err := sql.Open("mysql", "homestead:secret@tcp(192.168.10.10:3306)/golang_restful_api_test?parseTime=true")
...
func TestGetCategoryFailed(t *testing.T) {
	...
	router := setupRouter(db)
	request := httptest.NewRequest(http.MethodGet, "http://localhost:3000/api/categories/500", nil)
	request.Header.Add("X-API-Key", "RAHASIA")
...
func TestDeleteCategoryFailed(t *testing.T) {
	...
	router := setupRouter(db)
	request := httptest.NewRequest(http.MethodDelete, "http://localhost:3000/api/categories/501", nil)
	request.Header.Add("Content-Type", "application/json")
	request.Header.Add("X-API-Key", "RAHASIA")
...
func TestUnauthorized(t *testing.T) {
	...
	router := setupRouter(db)
	request := httptest.NewRequest(http.MethodGet, "http://localhost:3000/api/categories", nil)
	request.Header.Add("X-API-Key", "fadfsafsasalah")
